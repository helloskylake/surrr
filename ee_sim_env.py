...
class SingleEETask(base.Task):
    ...
    def before_step(self, action, physics):
        ...
        np.copyto(physics.data.ctrl[-1:], np.array([g_left_ctrl]))  
    ...
    def get_qpos(physics):
        ...
        left_gripper_qpos = [PANDA_GRIPPER_POSITION_NORMALIZE_FN(left_qpos_raw[7])*(255/0.04)]  
...
class SingleCubeEETask(SingleEETask):
    ...
    def get_reward(self, physics):
        ...
        touch_left_gripper = check_collision(['fpc1', 'fpc2', 'fpc3', 'fpc4', 'fpc5', ], 'red_box', all_contact_pairs)  
